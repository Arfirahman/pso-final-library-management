        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <form action="{{ route('admin.books.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="author" id="author" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('author') border-red-500 @enderror" value="{{ old('author') }}" required>
                    @error('author')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="number" name="year" id="year" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('year') border-red-500 @enderror" value="{{ old('year') }}" required>
                    @error('year')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="number" name="available" id="available" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('available') border-red-500 @enderror" value="{{ old('available') }}" required>
                    @error('available')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
