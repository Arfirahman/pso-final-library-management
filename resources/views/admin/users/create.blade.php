    ...
    <div class="container mx-auto p-4">
        ...
        <nav class="mb-8 bg-white p-4 rounded-lg shadow-md">
            <ul class="flex space-x-6">
                ...
                <li><a href="{{ route('admin.borrows.index') }}" class="text-gray-500 hover:text-blue-800 font-semibold">Record Borrowing</a></li>
                <li><a href="{{ route('admin.users.create') }}" class="text-blue-600 hover:text-blue-800 font-semibold">Add User</a></li>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold mb-4 text-gray-800">Add New User</h2>
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                {{-- Password and Confirm Password fields are removed as requested --}}
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="age" id="age" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('age') border-red-500 @enderror" value="{{ old('age') }}">
                    @error('age')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Cancel</a>
                </div>
            </form>
        </div>
    </div>
